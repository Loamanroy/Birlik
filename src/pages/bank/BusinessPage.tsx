function BusinessPage() {
    return (
        <div className="container mx-auto px-4 pt-6">
            <div className="mb-6">
                <h1 className="text-2xl font-bold">Бизнес-банкинг</h1>
                <p className="text-gray-600 mt-2">Управление бизнес-счетами и финансами компании</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-white rounded-xl shadow-sm p-6">
                    <h2 className="text-lg font-bold mb-4">Счета компании</h2>
                    <div className="space-y-4">
                        {[
                            {
                                name: "Основной счет ТОО",
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                    <h2 className="text-lg font-bold mb-4">Финансовая аналитика</h2>
                    <div className="h-48 bg-gray-100 rounded-lg mb-4 flex items-center justify-center">
                        <p className="text-gray-500">График движения средств</p>
                    </div>
                    <div className="space-y-3">
                        <div className="flex justify-between">
                            <span className="text-gray-600">Доходы за месяц</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white rounded-xl shadow-sm p-6">
                    <h2 className="text-lg font-bold mb-4">Платежи</h2>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                    <h2 className="text-lg font-bold mb-4">Зарплатный проект</h2>
                    <div className="space-y-2">
                        <button className="w-full px-4 py-3 bg-gray-50 hover:bg-gray-100 text-left rounded-lg flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                    <h2 className="text-lg font-bold mb-4">Бизнес-услуги</h2>
                    <div className="space-y-2">
                        <button className="w-full px-4 py-3 bg-gray-50 hover:bg-gray-100 text-left rounded-lg flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
                <h2 className="text-lg font-bold mb-4">Последние операции</h2>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {[
                                {
                                    date: "25.05.2023",
                                    description: "Оплата поставщику ТОО 'АлматыСтрой'",
                                    account: "Основной счет ТОО",
                                    amount: "-450 000,00 ₸",
                                    status: "Выполнен",
                                    positive: false
                                },
                                {
                                    date: "24.05.2023",
                                    description: "Поступление от ТОО 'Астана Инвест'",
                                    account: "Основной счет ТОО",
                                    amount: "+780 000,00 ₸",
                                    status: "Выполнен",
                                    positive: true
